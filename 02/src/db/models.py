...
class User(SQLModel, table = True):   
    ...
    reviews: List["ReviewsModel"] = Relationship(back_populates="user", sa_relationship_kwargs={"lazy": "selectin"})
...
class BookModel(SQLModel, table = True):
    ...
    reviews: List["ReviewsModel"] = Relationship(back_populates="book", sa_relationship_kwargs={"lazy": "selectin"})
...
class ReviewsModel(SQLModel, table = True):
